...
export default function Hero() {
  return (
    ...
    <div className='flex flex-col items-center  '>
        ...
        <div className='sm:text-7xl text-4xl px-10 sm:leading-snug text-center text-gray-800 w-10/12 break-words '>Transform Dreams into Global Ventures with CorpConnect</div>
